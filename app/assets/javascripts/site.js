window.onload = function() {
  ...
  canvas.setBackgroundImage('/assets/DPS/plans-sample.jpg', canvas.renderAll.bind(canvas));
...
$('#areaNoField').change(function(){
	
	if (($('#areaNoField').val()!="") & ($("#siteNoField").val()!="")){
		
		alert($('#areaNoField').val());
		alert($("#siteNoField").val());
